...
- **CIS source imagery metadata.** Whether SIGRID-3 files contain metadata identifying the SAR acquisitions used to derive each polygon. If available, this enables a materially stronger form of (SAR, chart) alignment for the 2025–26 evaluation pipeline than date-based matching.
