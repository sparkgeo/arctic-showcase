...
SIC_GROUPS = {0: 0, 1: 10, 2: 20, 3: 30, 4: 40, 5: 50, 6: 60, 7: 70, 8: 80, 9: 90, 10: 100}
...
LOOKUP_NAMES = {"SIC": SIC_LOOKUP, "SOD": SOD_LOOKUP, "FLOE": FLOE_LOOKUP}

# Wraps the group names together.
GROUP_NAMES = {"SIC": SIC_GROUPS, "SOD": SOD_GROUPS, "FLOE": FLOE_GROUPS}
